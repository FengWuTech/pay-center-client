...
const (
	...
	URL_STATISTICS_RECHARGE_DAILY = "http://pms-api.gmtech.top/pay-center/statistics/recharge/daily"
	URL_STATISTICS_RECHARGE_MONTH = "http://pms-api.gmtech.top/pay-center/statistics/recharge/month"
